...
/*
 * Универсальный набор костылей
 */
global $current_user;
$loc = Contact::getLoc($this);
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          5 =>
          array (
              'customCode' => '<input type="button" class="button" onClick="window.location.href=\'index.php?module=Contacts&action=StaticSender&name='.$this->focus->name.'&email='.$this->focus->email1.'&user='.$current_user->full_name.'\'" value="Отправить письмо">',
          ),
          'AOS_GENLET' => 
          array (
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          array (
            'name' => 'name',
              /*'customCode' => '<font color="#7fffd4">{$fields.name.value}</font> и {$fields.title.value}',*/ //а нужно было так
          ...
          array (
            'name' => 'birthdate',
            'comment' => 'Birthdate of the contact',
            'label' => 'LBL_BIRTHDATE',
          ),
        ),
        1 => 
      ...
      array (
        ...
        array (
          ...
          array (
            'name' => 'date_entered',
            'customCode' => '{$fields.date_entered.value} {$APP.LBL_BY} {$fields.created_by_name.value}', //тут уже нечего объединять
              ...
              0 =>
                  array (
                      0 =>
                          array (
                              'name' => 'Geolocation',
                              'customCode' => '<iframe src="https://maps.google.com/maps/embed/v1/place?key=AIzaSyBxjVvCqSS7ttl43sUOQzwd2reUg7uKERc&q='.$loc->lat.','.$loc->lng.'" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>',
                              'comment' => '',
                              'label' => 'Geolocation',
                          ),
                      1 =>
              ...
              0 =>
                  array (
                      0 =>
                          array (
                              'name' => 'Video',
                              'customCode' => '<iframe src="http://vk.com/video_ext.php?oid=-46172262&id=169475512&hash=2dcd5fa32af38557&sd"
                                                 width="310" height="180" frameborder="0" allowfullscreen>
                                                 </iframe>',
                              'comment' => '',
                              'label' => 'Video',
                          ),
