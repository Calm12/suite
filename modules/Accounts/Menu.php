...
if(ACLController::checkAccess('Accounts', 'list', true))$module_menu[]=Array("index.php?module=Accounts&action=ShowAltList", $mod_strings['LNK_ALT_ACCOUNT_LIST'],"AltList", 'Accounts');
