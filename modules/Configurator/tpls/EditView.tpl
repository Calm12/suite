...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
		<tr>
			<th align="left" scope="row" colspan="4"><h4>Остальные параметры</h4></th>
		</tr>
		<tr>
			<td width="25%" scope="row" valign='middle'>Тестовый параметр: </td>
			{if !empty($config.system_test01)}
				{assign var='system_test01_checked' value='CHECKED'}
			{else}
				{assign var='system_test01_checked' value=''}
			{/if}
			<td width="75%" align="left"  valign='middle'><input type='hidden' name='system_test01' value='false'><input name='system_test01'  type="checkbox" value='true' {$system_test01_checked}></td>
		</tr>
	</table>
